...
using Prism.Events;
using Prism.Mvvm;
using ReferenceConflictsModule;
...
namespace AssembliesTools
{
    ...
    {
        private const string ModuleCatalogUri = "/AssembliesToos;component/ModulesCatalog.xaml";
        ...
        protected override void ConfigureModuleCatalog()
        {
            var moduleTypes = new[]
            {
                typeof(ConflictsModule),
                typeof(DirectoryModule),
                typeof(ListingModule.ListingModule)
            };

            foreach (var o in moduleTypes)
                ModuleCatalog.AddModule(new ModuleInfo(o.Name, o.AssemblyQualifiedName));
